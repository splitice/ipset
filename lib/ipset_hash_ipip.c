...
static struct ipset_type ipset_hash_ipip1 = {
	.name = "hash:ip,ip",
	.alias = { "ipiphash", NULL },
	.revision = 1,
...
/* counters support */
static struct ipset_type ipset_hash_ipip2 = {
	.name = "hash:ip,ip",
	.alias = { "ipiphash", NULL },
	.revision = 2,
	.family = NFPROTO_IPSET_IPV46,
...
/* comment support */
static struct ipset_type ipset_hash_ipip3 = {
	.name = "hash:ip,ip",
	.alias = { "ipiphash", NULL },
	.revision = 3,
	.family = NFPROTO_IPSET_IPV46,
...
/* forceadd support */
static struct ipset_type ipset_hash_ipip4 = {
	.name = "hash:ip,ip",
	.alias = { "ipiphash", NULL },
	.revision = 4,
	.family = NFPROTO_IPSET_IPV46,
...
/* skbinfo support */
static struct ipset_type ipset_hash_ipip5 = {
	.name = "hash:ip,ip",
	.alias = { "ipiphash", NULL },
	.revision = 5,
	.family = NFPROTO_IPSET_IPV46,
...
/* skbinfo support */
static struct ipset_type ipset_hash_ipip6 = {
...
void _init(void)
{
	ipset_type_add(&ipset_hash_ipip1);
	ipset_type_add(&ipset_hash_ipip2);
	ipset_type_add(&ipset_hash_ipip3);
	ipset_type_add(&ipset_hash_ipip4);
	ipset_type_add(&ipset_hash_ipip5);
	ipset_type_add(&ipset_hash_ipip6);
}